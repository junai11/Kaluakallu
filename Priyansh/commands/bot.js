...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "🤮") || (event.body.toLowerCase() == "🤮")) {
    ...
    if ((event.body.toLowerCase() == "🤗") || (event.body.toLowerCase() == "🤗")) {
     return api.sendMessage("Hug Karta Hai Ruk Meri Chappal Kaha Hai  ☺️", threadID);
   };
...
if ([
 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "Hello") || (event.body.toLowerCase() == "good morning")) {
   ...
   if ((event.body.toLowerCase() == "🥱") || (event.body.toLowerCase() == "mohd faisal") || (event.body.toLowerCase() == "Uves") || (event.body.toLowerCase() == "")) {
     return api.sendMessage( "kiya 😒 Pareshani Hai Bhai ye sajjan ko isko uthake 👋 Bahar Feko Bhai koi 🤣",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𝐔𝐕𝐄𝐒 𝐀𝐋𝐈꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐔𝐕𝐄𝐒 𝐀𝐋𝐈🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/share/1J9eWKUSyB/👋For Any Kind Of Help Contact On Telegram  Username 👉 @uvesali😇", threadID);
   };

   if ((event.body.toLowerCase() == "bot kiska hai ") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Uves Ali ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is uves. He Gives his name Uves everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😡😡😡") || (event.body.toLowerCase() == "😡") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
     return api.sendMessage("️🥺 Me To Mazak Kar Raha Tha Gussa Na Karo Ye Lo Mere Boss Uves Ka Wp Num 00966510****52 😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Babu") || (event.body.toLowerCase() == "babu") || (event.body.toLowerCase() == "ram ram")) {
    return api.sendMessage("️𝐘𝐞𝐬 𝐌𝐞𝐫𝐢 𝐉𝐚𝐚𝐧 𝐁𝐨𝐥𝐨 😇", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🙂") || (event.body.toLowerCase() == "🙃")) {
     return api.sendMessage("️Best Of luck 🤞  🥰", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😉") || (event.body.toLowerCase() == "😉")) {
   ...
   if ((event.body.toLowerCase() == "😱") || (event.body.toLowerCase() == "😨")) {
     return api.sendMessage("️Kya hua Aaina dekh liya kya 👻👻", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i love you")) {
